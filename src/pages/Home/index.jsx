  ...
  return (
    <div>
      ...
      sx={{
        ...
        alignItems: 'center',
        padding: '50px',
        backgroundImage: 'url(https://static.wixstatic.com/media/c837a6_5b41865393e44ee88011d8d373985afc~mv2.jpg/v1/fill/w_1899,h_519,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/c837a6_5b41865393e44ee88011d8d373985afc~mv2.jpg)', // Thay thế bằng đường dẫn của hình nền
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        color: 'white',
        height: '300px',
    ...
    <Box sx={{ }}>
      <Typography variant="h4" sx={{ marginBottom: '30px', fontWeight: 'bold', textAlign: 'left',marginTop: '60px',}}>
        ...
        <Grid item xs={12} md={6}>
          <Box
            sx={{
              ...
              borderRadius: '8px',
              height: '500px',
              backgroundImage: 'url(https://static.wixstatic.com/media/c837a6_af21d0be8ad54ce4adc6acb7a2decb91~mv2.jpg/v1/fill/w_591,h_600,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/body.jpg)', // Hình ảnh Body Fragrances
              backgroundSize: 'cover',
              backgroundPosition: 'center',
            }}
          >
        ...
        <Grid item xs={12} md={6}>
          <Box
            sx={{
              ...
              borderRadius: '8px',
              height: '500px',
              backgroundImage: 'url(https://static.wixstatic.com/media/84770f_6b8b418c932f49e39e3097cac4f58e11~mv2.jpg/v1/fill/w_950,h_965,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/Frame%2022.jpg)', // Hình ảnh Home Scents
              backgroundSize: 'cover',
              backgroundPosition: 'center',
            }}
          >
      ...
      <Grid container spacing={0}>
        ...
        <Grid item xs={12} md={6}>
          <Box sx={{ padding: '20px' }}>
            ...
            <Typography variant="subtitle1" sx={{ marginBottom: '30px', fontWeight: 'bold' }}>
              Kể từ năm 1960
            </Typography>
            <Typography variant="body1" sx={{ lineHeight: '1.6' }}>
            Đây là một không gian để chia sẻ thêm về doanh nghiệp: ai đứng sau nó, nó làm gì và trang web này mang đến điều gì. Đây là cơ hội để kể câu chuyện đứng sau doanh nghiệp hoặc mô tả một dịch vụ hoặc sản phẩm đặc biệt mà nó cung cấp. Bạn có thể sử dụng phần này để chia sẻ lịch sử của công ty hoặc làm nổi bật một tính năng cụ thể giúp nó nổi bật so với các đối thủ.
            Hãy để những gì bạn viết nói lên chính nó. Giữ một giọng điệu và phong cách nhất quán xuyên suốt trang web để trung thành với hình ảnh thương hiệu và cho khách truy cập cảm nhận về giá trị và cá tính của công ty.
            </Typography>
          </Box>
        </Grid>
        ...
        <Grid item xs={12} md={6}>
          <Box
            sx={{
              height: '100%',
              backgroundImage: 'url(https://static.wixstatic.com/media/c837a6_7f2fccf4a9c14386935bd5d9f65e982b~mv2.jpg/v1/fill/w_950,h_916,fp_0.50_0.50,q_85,usm_0.66_1.00_0.01,enc_auto/yuvalna_fine_art_photographytextures_reminiscent_of_sea_anemo_c44a10de-4080-4b39-8787-1436.jpg)', // Thay bằng đường dẫn tới hình ảnh của bạn
              backgroundSize: 'cover',
              backgroundPosition: 'center',
            }}
          />
